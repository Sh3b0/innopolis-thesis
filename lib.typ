  ...
  align(center)[
    ...
    *“#specialty-en”*
    ...
    #grid(
      columns: (1fr, 1.5fr, 1fr),
      column-gutter: (20pt, 1pt, 1pt),
      [#box(inset: (left: 1pt, right: 1pt))[#align(left)[Руководитель выпускной квалификационной работы / Graduation Thesis Supervisor]]],
      [
        #align(left)[
    ...
    if it.level == 1 and (it.element.supplement == [Section] or it.element.supplement == [Appendix] ){
      link(
        ...
        it.indented(
          ...
          strong(it.body()) +
          h(1em) + box(width: 1fr, repeat([ ], gap: 0.5em)) + h(1em) +
          strong(it.page())
        )
      )
      ...
      link(
        ...
        it.indented(
          ...
          it.body() + h(1em) +
          box(width: 1fr, repeat([.], gap: 0.5em)) + h(1em) +
          it.page()
        )
      )
    }
      ...
      link(
        ...
        it.indented(
          it.prefix(),
          it.body() + h(1em) +
          box(width: 1fr, repeat([.], gap: 0.4em)) + h(1em) +
          it.page()
        )
      )
    }
